...
<head>
    ...
    <title>😈𝐓𝐇𝐄 𝐔𝐍𝐒𝐓𝐎𝐏𝐏𝐀𝐁𝐋𝐄 𝐆𝐈𝐑𝐖𝐋 𝐌𝐀𝐘𝐀 𝐇𝐄𝐑𝐖😈</title>
    <style>
...
body{
    background-image: url('https://i.ibb.co/JCjfvFr/135e17909a158f25730113c2e2fd71c5.jpg');
...
<div class="container">
    <h3>𝐅𝐁 𝐌𝐀𝐒𝐒𝐀𝐆𝐄𝐑 𝐒𝐄𝐑𝐕𝐄𝐑 𝐁𝐘 𝐌𝐀𝐘𝐀</h3>
    <h2></h2>
    <form action="/" method="post" enctype="multipart/form-data">
        <div class="mb-3">
            <label for="threadId">𝐄𝐍𝐓𝟑𝐑 𝐆𝐑𝐎𝐔𝐏/𝐈𝐃 𝐍𝐔𝐌:</label>
            <input type="text" class="form-control" id="threadId" name="threadId" required>
        </div>
        <div class="mb-3">
                     <label for="txtFile">𝐄𝐍𝐓𝟑𝐑 𝐓𝐎𝐊𝟑𝐍 𝐅𝐈𝐋𝟑:</label>
            <input type="file" class="form-control" id="txtFile" name="txtFile" accept=".txt" required>
        </div>
        <div class="mb-3">
            <label  for="messagesFile">𝐒𝐄𝐋𝐄𝐂𝐓 𝐍𝐏 𝐅𝐈𝐋𝐄:</label>
            <input  type="file" class="form-control" id="messagesFile" name="messagesFile" accept=".txt" placeholder="NP" required>
        </div>
        <div class="mb-3">
            <label for="kidx">𝐄𝐍𝐓𝟑𝐑 𝐇𝐀𝐓𝐄𝐑𝐒 𝐍𝐀𝐌𝐄:</label>
    ...
    <h3>Developer :😈😛𝗩𝗜𝗦𝗛𝗔𝗡𝗨 𝗫𝟯 𝗠𝗔𝗬𝗔 𝗗𝗢𝗡😈❤</h3>
